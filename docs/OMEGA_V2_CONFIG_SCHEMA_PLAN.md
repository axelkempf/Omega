...
| [OMEGA_V2_TRADE_MANAGER_PLAN.md](OMEGA_V2_TRADE_MANAGER_PLAN.md) | Trade-/Position-Management: Config-Schema Erweiterungen (TM-Block) |
...
| [OMEGA_V2_TESTING_VALIDATION_PLAN.md](OMEGA_V2_TESTING_VALIDATION_PLAN.md) | Config-Normalisierung für Tests, Determinismus-Checks, Golden-Files |
...
- Für V1-Python↔V2 Regressionen in DEV ist eine explizite Paritätsvariante zulässig (siehe Vision- und Testing-Plan).
