...
mod htf_lookahead {
    ...
    fn test_htf_index_mapping_returns_none_when_no_htf() {
        let primary = make_store(
            vec![
                1704067200_000_000_000, // 2024-01-01 00:00:00
                1704067500_000_000_000, // 2024-01-01 00:05:00
            ],
            Timeframe::M5,
        );
    ...
    fn test_htf_index_mapping_basic() {
        ...
        let primary = make_store(
            vec![
                1704067200_000_000_000, // 2024-01-01 00:00:00
                1704067500_000_000_000, // 2024-01-01 00:05:00
                1704067800_000_000_000, // 2024-01-01 00:10:00
                1704068100_000_000_000, // 2024-01-01 00:15:00
                1704070800_000_000_000, // 2024-01-01 01:00:00 (new H1 bar)
                1704071100_000_000_000, // 2024-01-01 01:05:00
            ],
            Timeframe::M5,
        );
        ...
        let htf = make_store(
            vec![
                1704067200_000_000_000, // 2024-01-01 00:00:00
                1704070800_000_000_000, // 2024-01-01 01:00:00
            ],
            Timeframe::H1,
        );
...
mod warmup_validation {
    ...
    fn make_store(count: usize) -> CandleStore {
        let timestamps: Vec<i64> = (0..count)
            .map(|i| 1704067200_000_000_000 + (i as i64) * 300_000_000_000)
            .collect();
        let bid: Vec<Candle> = timestamps.iter().map(|&ts| make_candle(ts)).collect();
        let ask = bid.clone();
        CandleStore {
