...
class TestIndicatorCacheParity:
    ...
    def test_bollinger_parity(self, sample_data: Dict[str, Dict[str, List[Any]]]) -> None:
    ...
    def test_choppiness_parity(self, sample_data: Dict[str, Dict[str, List[Any]]]) -> None:
    ...
    def test_kalman_mean_parity(self, sample_data: Dict[str, Dict[str, List[Any]]]) -> None:
